...
namespace Re_QuanLiKS
{
    public partial class RoomReport : Form
    {
        ...
        public RoomReport(string RoomID)
        {
            InitializeComponent();
            roomID = RoomID;
            ...
            label_TotalPrice.Text = calculatePriceOfTotalTimeToString();
            //get Note
        ...
        private string calculatePriceOfTotalTimeToString()
        {
            ...
            string checkoutDateTimeString = label_CheckoutDateTime.Text;
            DateTime checkoutDateTime = DateTime.Parse(checkoutDateTimeString);
